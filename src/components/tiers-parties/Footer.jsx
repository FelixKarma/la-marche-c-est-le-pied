...
const Footer = ({ fixed }) => {
  return (
      <footer className={`p-2 d-flex justify-content-evenly align-items-center ${fixed ? 'position-fixed' : 'position-relative'} bottom-0 w-100`}>
          ...
          <NavLink to='' className='text-white link-light link-underline-opacity-0 link-underline-opacity-100-hover '>lamarcheclepied@laposte.net</NavLink>
          ...
          <NavLink to="" className='text-white link-light link-underline-opacity-0 link-underline-opacity-100-hover'>S’inscrire</NavLink>
    </footer>
  )
}
